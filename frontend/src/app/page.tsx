          ...
          {filteredAndSortedItems.length === 0 ? (
            ...
            filteredAndSortedItems.map(item => {
              ...
              return (
                <div
                  key={item.id}
                  className={`p-3.5 hover:bg-surfaceElevated/60 transition-all group ${tierAccent} ${
                ...
                >
                  ...
                  <div className="mt-2.5 pt-2 border-t border-surfaceBorder/40 flex flex-wrap items-center justify-between gap-2">
